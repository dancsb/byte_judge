...
const sendEmail = (username, email, activationLink) => {
    const mailOptions = {
        from: `"ByteJudge" <no-reply@${urls.frontend.replace(/^https?:\/\//, '')}>`, // Sender address
        to: `"${username}" <${email}>`, // Recipient address
        subject: 'Activate Your ByteJudge Account', // Subject line
        ...
        <div style="font-family: Arial, sans-serif; line-height: 1.5; color: #333;">
            ...
            <div style="text-align: center; padding: 20px 0; background: #f8f9fa; border-bottom: 1px solid #ddd;">
                <h1 style="color: #6c757d; font-size: 36px; margin: 0;">ByteJudge</h1>
            </div>
            ...
            <div style="padding: 20px; background: #fff;">
                ...
                <p style="font-size: 16px; color: #555;">
                    Thank you for signing up for ByteJudge! Please confirm your email address to activate your account.
                </p>
            ...
            <div style="text-align: center; padding: 10px 0; background: #f8f9fa; border-top: 1px solid #ddd;">
                <p style="font-size: 12px; color: #777;">
                    You’re receiving this email because you signed up for ByteJudge. If this wasn’t you, please ignore this email.
                </p>
                <p style="font-size: 12px; color: #777;">
                    ByteJudge | <a href="${urls.frontend}" style="color: #007bff;">${urls.frontend}</a>
                </p>
            </div>
        </div>
        ` // HTML body
